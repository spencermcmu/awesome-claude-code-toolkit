...
| [Outreach Magic](https://github.com/outreachmagic/outreachmagic) | `npx skills add outreachmagic/outreachmagic` | **GTM pipeline agent** that syncs Smartlead, Instantly, HeyReach, PlusVibe, EmailBison, Prosp, and Calendly into a local SQLite database your agent can query. Every send, reply, bounce, and stage change lands on your machine. |
